        ...
        >
            <div 
                className={`flex items-center justify-between w-full max-w-5xl px-6 py-3 rounded-2xl transition-all duration-300 ${
                    scrolled 
                        ? "bg-white/80 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200 dark:border-slate-700/50 shadow-2xl shadow-black/5 dark:shadow-black/20" 
            ...
            >
                ...
                <Link to="/" className="flex items-center space-x-2 group">
                    ...
                    <span className="text-lg font-bold text-slate-900 dark:text-slate-100 tracking-tight transition-colors">SyncWrite</span>
                </Link>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <Link
                        to={session ? "/" : "/register"}
                        className="relative group px-4 py-2 text-sm font-medium text-white rounded-lg overflow-hidden bg-slate-900 dark:bg-slate-800 border border-slate-800 dark:border-slate-700 transition-all hover:border-slate-700 dark:hover:border-slate-600 shadow-lg"
                    >
