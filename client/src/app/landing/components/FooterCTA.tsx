...
export function FooterCTA() {
    return (
        <section className="w-full relative overflow-hidden py-32 mt-20 border-t border-slate-800 bg-slate-950">
            
            {/* Background glow */}
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gradient-to-t from-indigo-900/40 to-transparent blur-[100px] pointer-events-none" />
            ...
            <div className="relative w-full max-w-4xl mx-auto px-6 text-center z-10">
                ...
                <div className="mt-32 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500">
                    <div className="flex items-center space-x-2 mb-4 md:mb-0">
                        ...
                        <span className="font-semibold text-slate-300">SyncWrite</span>
