...
export function RibbonMenu({ editor, disabled = false, role = "OWNER" }: RibbonMenuProps) {
    ...
    const [showPageNumberSubMenu, setShowPageNumberSubMenu] = useState<'top' | 'bottom' | null>(null);
                                                ...
                                                <div className="absolute top-full mt-1 left-0 bg-white border border-slate-300 shadow-xl z-50 w-56 rounded-sm py-1">
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            setFormatPageStyle(editor.getAttributes('document').pageNumberFormat || 'numeric');
                                                            setShowFormatPageNumberDialog(true);
                                                    ...
                                                    >
                                                        ...
                                                        <div className="max-h-64 overflow-y-auto">
                                                            ...
                                                            >
                                                                ...
                                                                <div className="border border-slate-200 h-16 bg-white relative">
                                                                    <div className={`absolute ${showPageNumberSubMenu === 'top' ? 'top-2' : 'bottom-2'} right-2 text-[8px] text-slate-800`}>1</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <input
                                                                ...
                                                                onChange={(e) => setFormatPageStart(e.target.value)}
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex justify-end space-x-2 mt-2 pt-3 border-t border-slate-100">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                setShowFormatPageNumberDialog(false);
                                                            }}
                                                        >
                                                            OK
                                                        </button>
